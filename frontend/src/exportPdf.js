...
export function generateRevisionPdf(exportText, revisedSections, profile, score) {
  ...
  drawDivider(doc, y);
  y += 6;
  writeWrapped(doc, 'This report was generated by Research Copilot. AI was used only for language refinement — all changes were reviewed and accepted by the author. Final editorial responsibility remains with the authors.', MARGIN, y, TEXT_W, { size: 8, color: [120, 120, 120] });
